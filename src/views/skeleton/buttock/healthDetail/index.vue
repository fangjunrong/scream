...
export default {
  ...
  methods: {
    ...mapActions('skeletonButtock', [
      'fetchSkeletonButtockBendNumDetail'
    ]),
    async search() {
      const param = _.assign(this.filter, { pageSize: 10, pageNumber: 1 })
      const result = await this.fetchSkeletonButtockBendNumDetail(param)
      if (result.code !== 200) {
    ...
    async getData(param) {
      return await this.fetchSkeletonButtockBendNumDetail(param)
    },
