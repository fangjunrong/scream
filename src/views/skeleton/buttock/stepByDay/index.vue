<template>
  <div class="skeletonButtockStepByDay">
    <div class="skeletonButtockStepByDay-title">
    ...
    <div class="skeletonButtockStepByDay-charts">
      ...
      <div class="skeletonButtockStepByDay-charts-container">
        <div class="chart3">
...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      const result = await this.fetchSkeletonButtockStepsTotal({
        pageNumber: 1,
        pageSize: 10
      })
      if (result.code !== 200) {
...
<style>
.skeletonButtockStepByDay .el-form-item__label{
  font-weight: bold;
  font-size: 14px;
  color: #00F0FA;
}
.skeletonButtockStepByDay .el-tabs__nav{
  float: none;
  text-align: center;
}
</style>
