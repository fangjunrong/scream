<template>
  <div class="skeletonButtockStepNumDetail">
    <div class="skeletonButtockStepNumDetail-title">
      <DetailTitle title="步数详情"/>
    </div>
    <div class="skeletonButtockStepNumDetail-filter">
      设备型号：{{ filter.model }} 设备序列号：{{ filter.sn }}
    </div>
    <div class="skeletonButtockStepNumDetail-charts">
      ...
      <div class="skeletonButtockStepNumDetail-charts-container">
        <div class="chart3">
...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      const result = await this.fetchSkeletonButtockStepsNumDetail({
        pageNumber: 1,
        pageSize: 10
      })
      if (result.code !== 200) {
...
<style>
.skeletonButtockStepNumDetail .el-form-item__label{
  font-weight: bold;
  font-size: 14px;
  color: #00F0FA;
}
.skeletonButtockStepNumDetail .el-tabs__nav{
  float: none;
  text-align: center;
}
</style>
