  ...
  <div class="skeletonButtockSitDetail">
    ...
    <div class="skeletonButtockSitDetail-filter">
      <el-form :inline="true">
        ...
        <input type="button" class="s-button-primary skeletonButtockSitDetail-filter-search" value="查询" @click="search()"/>
      </el-form>
    </div>
    <div class="skeletonButtockSitDetail-table">
    ...
    <div class="skeletonButtockSitDetail-pagination">
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    initCharts() {
      ...
      this.brokeline.series[0].data = _.map(this.tableData, 'sitNum')
    },
    async search() {
      const param = _.assign(this.filter, { pageSize: 10, pageNumber: 1 })
      const result = await this.fetchSkeletonButtockSitNumDetail(param)
      if (result.code !== 200) {
...
<style>
.skeletonButtockSitDetail .el-form-item__label{
  font-weight: bold;
  font-size: 14px;
  color: #00F0FA;
}
