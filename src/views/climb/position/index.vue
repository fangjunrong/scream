    ...
    initMap() {
      ...
      if (_self.tableData.length > 0) {
        ...
        var marker = new AMap.Marker({
          ...
          title: _self.tableData[0].climbDeviceModel.model + ' : ' + _self.tableData[0].climbDeviceModel.sn,
          map: map
        })
        ...
        for (let i = 1; i < _self.tableData.length; i += 1) {
          ...
          marker = new AMap.Marker({
            position: point,
            // offset: new AMap.Pixel(-12,-12),
            title: _self.tableData[i].climbDeviceModel.model + ' : ' + _self.tableData[i].climbDeviceModel.sn,
            map: map
          })
